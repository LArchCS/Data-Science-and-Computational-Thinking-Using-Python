...
def getData(fileName):
    dataFile = open('E:\Edx\MIT_Python_2\Week4\L6_2_Errors in Experimental Observations_data.txt', 'r')
    distances = []
    masses = []
